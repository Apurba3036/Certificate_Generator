  ...
  return (
    <header className='bg-black fixed top-0 right-0 left-0 z-50'>
      <nav className='px-5 py-5 max-w-7xl mx-auto flex justify-between'>
        <a href="" className='text-lg font-bold text-white'>Certificate<span className='text-orange-400'>Generator</span></a>
        ...
        <div className='text-white md:flex gap-4 items-center hidden'>
          <a href="https://www.facebook.com/IUBAT" className='hover:text-orange-400'><FaFacebook></FaFacebook></a>
          <a href="https://iubat.academia.edu/" className='hover:text-orange-400'><FaDribbble></FaDribbble></a>
          <a href="https://x.com/IUBAT_BD" className='hover:text-orange-400'><FaTwitter></FaTwitter></a>
        <NavLink to="/login">
          <button className='bg-slate-400 px-5 py-2 rounded text-white font-bold hover:text-black hover:bg-slate-100 transition-all duration-200 ease-in'>
        Log in
      </button>
       </NavLink>
        </div>
